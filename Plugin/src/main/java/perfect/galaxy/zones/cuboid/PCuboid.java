package perfect.galaxy.zones.cuboid;
...
public class PCuboid implements Cloneable, ConfigurationSerializable, Iterable<Block> {

    protected String worldName;
    protected final Vector minimumPoint, maximumPoint;

    public PCuboid(PCuboid cuboid) {
    ...
    public PCuboid(Location loc) {
        this(loc, loc);
    }

    public PCuboid(Location loc1, Location loc2) {
    ...
    public PCuboid(String worldName, double x1, double y1, double z1, double x2, double y2, double z2) {
    ...
    @Override
    public PCuboid clone() {
        return new PCuboid(this);
    }
    ...
    public static PCuboid deserialize(Map<String, Object> serializedCuboid) {
        try {
            ...
            return new PCuboid(worldName, xPos1, yPos1, zPos1, xPos2, yPos2, zPos2);
        } catch (Exception ex) {
            ex.printStackTrace();
            return null;
        }

package perfect.versions.v1_12_R1;
...
public class Module_v1_12_R1 implements VersionModule {

    public void configure(@NotNull VersionProviderRegistry registry) {
        registry.registerVersionProvider(ActionbarMessenger.class, MinecraftVersion.v1_12_R1, new ActionbarMessenger_v1_12_R1());
        registry.registerVersionProvider(TitleMessenger.class, MinecraftVersion.v1_12_R1, new TitleMessenger_v1_12_R1());
    }
}
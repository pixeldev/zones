...
public class Module_v1_9_R2 implements VersionModule {
    ...
    public void configure(@NotNull VersionProviderRegistry registry) {
        registry.registerVersionProvider(ActionbarMessenger.class, MinecraftVersion.v1_9_R2, new ActionbarMessenger_v1_9_R2());
        registry.registerVersionProvider(TitleMessenger.class, MinecraftVersion.v1_9_R2, new TitleMessenger_v1_9_R2());
    }
}